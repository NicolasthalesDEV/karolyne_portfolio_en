              ...
              <div className="space-y-12 mt-12">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-lg">hello@karolynecosta.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-lg">+55 (11) 9 1234-5678</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-lg">São Paulo, Brazil</p>
                  </div>
                </div>
              </div>
